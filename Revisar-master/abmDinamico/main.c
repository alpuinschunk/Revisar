...
void listarEmpleadosPorSector(lista, 10, sectores, 5);
...
int main()
{
    ...
    inicializarEmpleados(lista, 10);            listarEmpleadosPorSector(lista, 10, sectores, 5);
...
void listarEmpleadosXSector(eEmpleado x[],int tam, eSector sectores[])
{
